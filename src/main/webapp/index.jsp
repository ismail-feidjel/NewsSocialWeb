                            ...
                            <div class="video-list-container">
                                <div class="match-event ch-soon">
                                    ...
                                    <div class="first-team">
                                        ...
                                        <div class="team-name">western</div>
                                    </div>
                                    <div class="match-time">
                                        <div class="match-timing">
                                            ...
                                            <span class="match-date soon" data-start="2022-04-24T15:00:00+02:00"
                                                data-gameends="2022-04-24T18:00:00+02:00">بعد قليل</span>
                                        </div>
                                    </div>
                                    <div class="left-team">
                                        <div class="team-logo">
                                            <img alt="تشيلسي" height="70" src="https://ssl.gstatic.com/onebox/media/sports/logos/bXkiyIzsbDip3x2FFcUU3A_96x96.png
                                                        " title="تشيلسي" width="70">
                                        </div>
                                        <div class="team-name">ليفربول</div>
                                    </div>
                                    <div class="match-info">
                                        <ul>
                                            <li><span>beIN 1 </span></li>
                                            <li><span>حفيظ الدراجي </span></li>
                                            <li><span>الكامب نو </span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="match-event ch-soon">
                                    ...
                                    <div class="left-team">
                                        ...
                                        <div class="team-name">انترميلان</div>
                                    </div>
                                    <div class="match-info">
                                        <ul>
                                            <li><span>beIN 1 </span></li>
                                ...
                                <div class="match-event ch-soon">
                                    ...
                                    <div class="first-team">
                                        ...
                                        <div class="team-name">ويسترن</div>
                                    </div>
                                    <div class="match-time">
                                        <div class="match-timing">
                                            <div id="match-hour">1:00 Ù</div>
